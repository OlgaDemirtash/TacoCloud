...
public class DesignTacoController {
    ...
    public void addIngredientsModel(Model model) {
        List<Ingredient> ingredients = Arrays.asList(new Ingredient(("FLTO"), "Flor Tortilla", Type.WRAP),
            ...
            new Ingredient(("CHED"), "Cheddar", Type.CHEESE), new Ingredient(("JACK"), "Monterrey Jack", Type.SAUCE),
